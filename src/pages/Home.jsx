        ...
        <div className="hero-container">
            <div className="hero-left reveal-left">
                ...
                <div className="cta-group">
                    <button className="primary-btn large cursor-target">Try Live Demo →</button>
                    <button className="secondary-btn large cursor-target">Read the Docs</button>
                </div>
        ...
        <div className="section-container">
            ...
            <div className="use-cases-grid reveal-up">
                <div className="persona-card">
                    ...
                    <a href="#" className="cta-link">See API Docs →</a>
                </div>
                ...
                <div className="persona-card">
                    ...
                    <a href="#" className="cta-link">See Evaluation Criteria →</a>
                </div>
                ...
                <div className="persona-card">
                    ...
                    <a href="#" className="cta-link">See Dashboard →</a>
                </div>
            </div>
        </div>
    </section>
...
streamlit run src/dashboard/app.py</code></pre>
            ...
            <div className="cta-actions">
                <button className="primary-btn large">Try Live Demo →</button>
                <button className="secondary-btn large">View on GitHub</button>
            </div>
