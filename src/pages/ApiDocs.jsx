...
const NAV_SECTIONS = [
    ...
    { id: 'post-batch',       label: 'POST /batch',       group: 'endpoints' },
            ...
            <div className="api-layout">
                ...
                <div className="api-sidebar">
                    ...
                    <div className="api-nav-section">
                        ...
                        <button onClick={() => scrollTo('post-batch')} className={linkClass('post-batch')}>POST /batch</button>
                    </div>
                ...
                <div className="api-main">
                    ...
                    <div className="api-header" id="post-evaluate">
                        ...
                        <p className="api-desc">
                            Evaluate a generated medical response for hallucination risk using multi-dimensional scoring including faithfulness, entity accuracy, source credibility, and contradiction detection. The API returns a structured audit report with a <strong style={{color:'var(--green-accent)'}}>Hallucination Risk Score (HRS)</strong> and detailed evaluation metrics.
                        </p>
                        ...
                        <div style={{display:'flex', gap:'12px', flexWrap:'wrap', marginBottom: '8px'}}>
                            ...
                            <div className="api-latency">
                                <span className="api-latency-icon"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg></span>
                                BASE URL: <span className="api-latency-green">http://localhost:8000</span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="api-code-window" style={{marginBottom: '40px'}}>
                                ...
                                {activeTab === 'python' && (
                                    <div className="ac-body">
                                        ...
                                        <br/>
                                        <div className="ac-code-line">url <span className="sc-keyword">=</span> <span className="sc-string-green">"http://localhost:8000/evaluate"</span></div>
                                        <br/>
                                        <div className="ac-code-line">payload <span className="sc-keyword">=</span> <span className="sc-obj">{'{'}</span></div>
                                        <div className="ac-code-line">    <span className="sc-string">"query"</span>: <span className="sc-string-green">"Dosage for Metformin?"</span>,</div>
                                        <div className="ac-code-line">    <span className="sc-string">"retrieved_chunks"</span>: [<span className="sc-string-green">"Metformin initial dose is 500 mg"</span>],</div>
                                        <div className="ac-code-line">    <span className="sc-string">"generated_answer"</span>: <span className="sc-string-green">"Start with 500 mg daily"</span></div>
                                        <div className="ac-code-line"><span className="sc-obj">{'}'}</span></div>
                                        <br/>
                    ...
                    <div className="config-block">
                        ...
                        <div className="timeline">
                            <div className="tl-item active">
                                <div className="tl-title">MAR 2026 — V1.4</div>
                                <div className="tl-desc">Added Bio-BERT based hallucination check layer.</div>
                            </div>
                            <div className="tl-item">
                                <div className="tl-title">JAN 2026 — V1.3</div>
                                <div className="tl-desc">Optimized GPU throughput for batch inference.</div>
                            </div>
                            <div className="tl-item">
