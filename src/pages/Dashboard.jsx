    ...
    return (
        <div className="dashboard-page">
            <div className="dashboard-container">
                ...
                {/* HEADER */}
                <div className="dash-header reveal-up">
                ...
                {/* KPI CARDS */}
                <div className="kpi-row-new reveal-stagger">
                ...
                {/* MIDDLE GRID */}
                <div className="mid-grid reveal-up">
                ...
                {/* BOTTOM GRID */}
                <div className="bot-grid reveal-up">
                                ...
                                {d.recentEvals.map((ev, i) => (
                                    <tr key={i}>
                                        ...
                                        <td className="td-action" style={{textAlign:'right'}}>
                                            <Link to="/evaluate" state={{ defaultView: 'report' }}>View<br/>Report</Link>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
                ...
                <div className="floating-badge reveal-up">
